...
-- Create date   : 1391/11/14
-- Viewed By	 : 
-- Last Modified : 
-- Last Modifier : 
-- Description	 : آمار فروش روزانه رستوران  
-- =============================================
Create PROCEDURE [sal].[RptSal_Restaurant_Daily_Stats] 
...
-- ================ SELECT ===========================
	...
	WHERE ' + @StrWhere + '
	GROUP BY d.GoodsID,Price,h.IsPackage,gd.GoodsName
