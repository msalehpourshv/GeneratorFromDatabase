...
-- ==============================================
Create PROCEDURE [trs].[SpReturnCheque]
...
--	WHERE DateAdd(Minute,5,ModifiedDate) < GetDate()
	...
	Select @StrWhere = ' and  PD2.PayTypeID IN (' + @StrPayTypeID + ')'
	IF @ProcessNo >0 
...
' + @StrWhere + '
group by VolumeFiscalYear, VolumeRowNo ) Vol
on PD.VolumeFiscalYear=Vol.VolumeFiscalYear and PD.VolumeRowNo=Vol.VolumeRowNo and PD.EventNo=Vol.EventNo
		...
		where PD.ProcessID in (13,18,24)'
