...
-- ==============================================
CREATE PROCEDURE [sal].[RptSale_Sor_Detailed] 
	@ProcessNo		Int = 1,
...
Begin --============== S T A R T  C O D E ===================================================
	...
	-- W H E R E --------------------------------------------------------------
	SET @StrWhere = ' (S.ProcessID=180) AND (S.ProcessNo=' + LTrim(Str(@ProcessNo)) + ') AND (S.ProcessNo=' + LTrim(Str(@ProcessNo)) + ')'
	...
	SET @StrSelect = '
		Select D.GoodsID ,[pub].[funGetGoodsName](D.GoodsID,' + LTrim(RTrim(@LangID)) + ') GoodsName,
		   IsNull([inv].[FunGetGoodsBarCode] (D.GoodsID), '''') BarCode ,D.SerialNo ,D.RowNo ,D.GoodsQuantity 
