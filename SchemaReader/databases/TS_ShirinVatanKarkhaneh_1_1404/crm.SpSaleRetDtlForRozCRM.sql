...
-- ==============================================
Create PROCEDURE crm.SpSaleRetDtlForRozCRM
	@AcntCode			Varchar(20), 
	@FrSerialNo			int,
	@ToSerialNo			int,
	@FrDate				char(10),
...
BEGIN
	...
	set @StrSelect='select a.ProcessID,a.ProcessNo,a.FiscalYear,a.SerialNo,a.RowNo,a.DocRowNo,a.DocStep,a.DocDate,a.StoreID,s.StoreName
						,a.AcntCode, pub.GetCodeName(a.AcntCode, 1) AcntName,a.VisitorAcntCode, pub.GetCodeName(a.VisitorAcntCode, 1) VisitorAcntName
						,a.SaleTypeID,t.SaleTypeName,a.GoodsID	,g.GoodsName,a.SubUnitID	,a.SubUnitQuantity	,a.GoodsQuantity
						,a.GoodsPrice	,a.SubUnitPrice,IsNull(U.UnitName,'''') As SubUnitName,a.DescDtl,a.BaseProcessID,a.BaseProcessNo
						,a.BaseFiscalYear,a.BaseSerialNo,a.BaseDocRowNo,a.DiscountPercentDtl,a.DiscountDtl,a.TaxOverWorthCostDtl	,a.TollOverWorthCostDtl	
					FROM inv.tblStorageDocsDtl a
						...
						Left Join inv.tblUnitsDtl U ON a.SubUnitID = U.UnitID  and U.LanguageID=1	
