...
-- ==============================================
-- crm.SpSaleReportHdrForTSCRM
Create PROCEDURE crm.SpSaleReportHdrForTSCRM
...
BEGIN
	...
	set @StrSelect='	
			SELECT a.ProcessID,a.ProcessNo,a.FiscalYear,a.SerialNo,a.DocDate
					...
					,a.DiscountPercent	,a.Discount	,a.Discount2+a.Discount3 Discount2,a.TransportationCost	,a.TransportationIncome	
