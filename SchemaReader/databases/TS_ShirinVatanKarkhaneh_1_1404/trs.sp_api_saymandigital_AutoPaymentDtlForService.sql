...
-- Description   : 
-- =============================================
create PROCEDURE [trs].[sp_api_saymandigital_AutoPaymentDtlForService]
...
begin
	...
	INSERT INTO trs.tblPayDtl
		(ProcessID,ProcessNo,FiscalYear,SerialNo,RowNo,DocRowNo,DocDate,ChequeDate,PayTypeID,CreditCode,DebitCode,
		 Amount,ChequeNo,LocationID,BankTypeID,BranchCode,BranchName,AccOwnerName,RowDesc)
	values
		(2,@ProcessNo,@FiscalYear,@SerialNo,@RowNo,@RowNo,@DocDate,@DocDate,3,@BankCode,@CustomerID,
