...
-- Description   : 
-- =============================================
create PROCEDURE inv.sp_api_AppService_CreateStorageDocsHdr
...
BEGIN TRY
	...
	Begin
		...
		SELECT 90, @ProcessNo, @FiscalYear, @maxSerialNo, 1, @DocDate, @StoreID, @AcntCode,
			@Amount,@Price,@DiscountPercent,@Discount,@Discount2, @TotalLineDiscount,@DocDesc,@SaleTypeID,
			@TaxOverWorthCost, @TollOverWorthCost,@DocDate DocDate2,@DocDate DocDate3,@DocDate DocDate4,'True' IsAutoDoc,
			@TransportationIncome,@TransferSerialNo
