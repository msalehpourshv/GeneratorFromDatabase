...
-- =========== TS-QC:NOTOK ========================
-- Author        : Hadi Sadeghi
-- Create date   : 90/12/27
-- Viewed By	 : 
-- Last Modified : 
-- Description   : 
-- =============================================
CREATE PROCEDURE [inv].[spFrmIOLoadConfirmDoc] 
 @ProcessID		smallint,
 @ProcessNo		tinyint,
 @FiscalYear	smallint,
 @SerialNo		int,
...
SET NOCOUNT ON;
	...
	SELECT DISTINCT S.ProcessID BaseProcessID , S.ProcessNo BaseProcessNo, S.FiscalYear BaseFiscalYear, S.SerialNo BaseSerialNo,S.DocRowNo BaseDocRowNo
	...
	Where ProcessID = @ProcessID  and ProcessNo= @ProcessNo AND FiscalYear=@FiscalYear AND SerialNo=@SerialNo) S
	LEFT JOIN 
	(
