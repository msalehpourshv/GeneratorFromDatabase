...
-- Description   : 
-- =============================================
CREATE PROCEDURE [acc].[SpVchPrd_ReceiveFromPln]
	@intVchNo				Int,
	@intDocStep				TinyInt,
    @strVchDate				Char(10),
...
BEGIN
	...
	SELECT top 1 @StoreID=StoreID,@ProducerAcntCode=AcntCode,@ProductID=GoodsID,@FormulaNo = FormulaNo
			,@GoodsQuantity = GoodsQuantity,@GoodsName = pub.funGetGoodsName(GoodsID,@LanguageID)
   ...
   WHERE StoreID = @StoreID
	...
	SELECT TOP 1 @FormulaProductCount =GoodsQuantity , @Wage = WageAmount 
