...
-- Description   : 
-- =============================================
Create PROCEDURE [acc].[SpVchBuyStocks]
	@intVchNo				Int,
	@intDocStep				TinyInt,
    @strVchDate				Char(10),
...
BEGIN
	...
	(
		...
		SET @StrSelect = '
		INSERT INTO #tbl_StocksBuy
		SELECT	S.BrokerageID,BD.BrokerageName,S.StocksSymbolID,SSD.StocksSymbolName,StocksQuantity,StocksPrice,BrokerWage,B.BrokerAcntCode,SS.StocksSymbolAcntCode
	...
	--------------------------------------------------------------------------------------------------------
	SET @strRecDesc = 'سند خرید سهام ' + LTRIM(RTRIM(STR(@intSourceFiscalYear))) + '/' + LTRIM(RTRIM(STR(@intSourceSerialNo))) 
		...
		Fetch NEXT From curAdvance Into @BrokerageID, @BrokerageName,@StocksSymbolID,@StocksSymbolName,@StocksQuantity,@StocksPrice,@BrokerWage,@BrokerAcntCode,@StocksSymbolAcntCode
				...
				IF @StocksPrice <> 0
					BEGIN
						...
						VALUES	(@intVchNo,@intSourceProcessID,@intSourceProcessNo,@intSourceFiscalYear,@intSourceSerialNo,@strVchDate ,1,@SessionNo ,1,@intMaxRowNo ,@intMaxDocRowNo,
								 @StocksSymbolAcntCode,(@StocksQuantity*@StocksPrice)+@BrokerWage,0,TS.pub.funChangeFarsiStrings(pub.funReverseForCrystal(@strRecDesc1)),'',0)	
						...
						INSERT INTO acc.tblVoucherDtl
								(SerialNo,SourceProcessID,SourceProcessNo,SourceFiscalYear,SourceSerialNo,DocDate,IsAutoDoc,SessionNo,VchKind,RowNo,DocRowNo,
									AcntCode,Debit,Credit,RecDesc,RecDesc2,SourceDocType) 
						VALUES	(@intVchNo,@intSourceProcessID,@intSourceProcessNo,@intSourceFiscalYear,@intSourceSerialNo,@strVchDate ,1,@SessionNo ,1,@intMaxRowNo ,@intMaxDocRowNo,
								 @BrokerAcntCode,0,(@StocksQuantity*@StocksPrice)+@BrokerWage,TS.pub.funChangeFarsiStrings(pub.funReverseForCrystal(@strRecDesc1)),'',0 )	
