...
-- Description   : 
-- =============================================
CREATE PROCEDURE inv.sp_api_VaraNegar_AutoSaleRetHdr
@ProcessNo as Int,
@FiscalYear as Int,
@DocStep as tinyint,
@DocDate as CHAR(10),
...
BEGIN TRY
	...
	SELECT 100 ProcessID ,@ProcessNo ProcessNo, @FiscalYear FiscalYear,@DocDate DocDate, @maxSerialNo SerialNo
END TRY
BEGIN CATCH
