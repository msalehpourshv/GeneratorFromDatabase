...
BEGIN --============== S T A R T  C O D E =====================================
	...
	-- S E L E C T ------------------------------------------------------------
	SET @StrSelect = '
		SELECT	D.AssetAcntCode, pub.GetCodeName(D.AssetAcntCode, ' + LTrim(Str(@LanguageID)) + ') AssetAcntName, 
