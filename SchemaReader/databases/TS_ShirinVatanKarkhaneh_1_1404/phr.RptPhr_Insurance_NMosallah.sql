...
-- Description	 : 
-- ==============================================
create PROCEDURE [phr].[RptPhr_Insurance_NMosallah]
...
Begin -- ============== S T A R T  C O D E ====================================
	...
	InsuranceTypeID <> '''' AND (RH.ReciptionTypeID = 1) AND (RH.Payed = 1)
	  AND (RH.Deleted = 0)  AND (RH.DisketNo = 0)  AND (RH.InsurancePortionSum > 0)
