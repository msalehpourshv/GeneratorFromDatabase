...
-- Description   : 
-- =============================================
-- Select [inv].[funGetGoodsRemainInPreSale] ('0101001', '01', '1394/12/10', 0, 2, 0, 3)
CREATE FUNCTION [inv].[funGetGoodsRemainInPreSale]
(	
	@GoodsID		Varchar(20),
	@StoreID		Varchar(20),
	@DocDate		Char(10),
...
BEGIN
	...
	WHERE H.ProcessID = 240 AND D.GoodsID = @GoodsID AND D.DocDate <= @DocDate AND 
