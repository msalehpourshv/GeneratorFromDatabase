...
-- Last Modifier : 
-- ----------------------------------------------
-- Description	 : <6 لیست تخفیفات 2 تا بخر 3 تا ببر>
-- ==============================================
Create PROCEDURE iw.Sp3buy2Pay6
	@UserID		int,
...
BEGIN	
	...
	set @StrSelect='select  Count(*)over () TotalCount, H.SerialNo	,H.FiscalYear	,H.DocDate	,H.FromDate	,H.ToDate	
						...
						,H.XBuy	,H.YPay,D1.DocRowNo	,D1.GoodsID	,D1.LenGoodsID
					from   sal.tbl3buy2PayHdr H
					left Join sal.tbl3buy2PayDtl6 D1 On D1.SerialNo=H.SerialNo and 	D1.FiscalYear=H.FiscalYear
					where 1= 1'
