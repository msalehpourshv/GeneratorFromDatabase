...
-- Description   : 
-- =============================================
Create PROCEDURE [inv].[sp_api_TakroSystem_UpdateStoreRequestsDtl]
...
BEGIN TRY
	...
	set DocDate=@DocDate, StoreID=@StoreID, AcntCode=@AcntCode,StoreID2= @StoreId2,
	GoodsID=@GoodsID, SubUnitID=@SubUnitID, SubUnitQuantity=@Quantity,GoodsQuantity=@Quantity,DescDtl=@DescDtl
	where
	 ProcessID=127 and ProcessNo=@ProcessNo and  FiscalYear=@FiscalYear and SerialNo=@SerialNo and RowNo=@RowNo
