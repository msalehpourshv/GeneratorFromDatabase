...
-- Description	 : لیست مزایای مستمر
-- ==============================================
Create PROCEDURE [prs].[RptPrs_Benefits1] 
...
Begin 
	...
	IF (@BenefitID Is Not Null) 
		SET @StrFieldsSum1 = 'Benefit' + LTrim(@BenefitID)		
	Else
		EXEC [pub].[SpConcatSimilarCols] 'prs', 'DecreeHdr', 'Benefit0', '+', @StrFieldsSum1 OUTPUT
