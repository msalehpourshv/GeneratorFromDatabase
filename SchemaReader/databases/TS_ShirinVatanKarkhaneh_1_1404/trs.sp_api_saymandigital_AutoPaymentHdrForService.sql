...
create PROCEDURE [trs].[sp_api_saymandigital_AutoPaymentHdrForService]
@ProcessNo		as tinyint,
@FiscalYear		as Int,
@DocDate		as CHAR(10),
@DescHdr		as NVARCHAR(max),
...
begin
	...
	INSERT INTO trs.tblPayHdr
		(ProcessID,ProcessNo,FiscalYear,SerialNo,CreditCode,DebitCode,DocDate,VchDate,DescHdr,TransferSerialNo)
	values
		(2,@ProcessNo,@FiscalYear,@maxSerialNo,@BankCode,@CustomerID,@DocDate,@DocDate,@DescHdr,@TransferSerialNo)	
