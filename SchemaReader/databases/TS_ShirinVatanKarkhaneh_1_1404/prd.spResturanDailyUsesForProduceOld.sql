...
-- Description   : 
-- =============================================
CREATE PROCEDURE prd.spResturanDailyUsesForProduceOld
@FromDate as CHAR(10),
@ToDate as CHAR(10),
...
BEGIN TRY
	...
	INNER JOIN (SELECT ProductID,SerialNo,ProductCount 
	            FROM prd.tblFormulasHdr 
	            WHERE ProductID = @GoodsID AND SerialNo = @FormulaNo ) f
