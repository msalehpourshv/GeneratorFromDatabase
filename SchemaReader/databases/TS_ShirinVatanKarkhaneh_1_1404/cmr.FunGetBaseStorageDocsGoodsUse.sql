...
-- Description   : 
-- =============================================
CREATE FUNCTION [cmr].[FunGetBaseStorageDocsGoodsUse]
(
@AcntCode Varchar(20),
@DocDate  char(10)
)
...
From
	(
		...
		Where ProcessID = 110 AND BaseProcessID > 0 AND
...
(
	...
	From inv.tblStorageDocsDtl 
	Where BaseProcessID = 110 AND (@AcntCode IS NULL   OR AcntCode = @AcntCode)
	Group BY BaseProcessID , BaseProcessNo , BaseFiscalYear , BaseSerialNo , 
			BaseDocRowNo
) Rtn
