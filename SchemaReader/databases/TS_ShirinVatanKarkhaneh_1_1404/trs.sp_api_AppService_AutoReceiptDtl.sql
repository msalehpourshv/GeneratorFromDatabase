...
-- Description   : Alian
-- =============================================
Create PROCEDURE [trs].[sp_api_AppService_AutoReceiptDtl]
...
begin
	...
	SELECT @BankCode=ISNULL(BankCode,''),@BankTypeID=ISNULL(BankTypeID,''),
	@LocationID=ISNULL(LocationID,''),@BranchCode=ISNULL(BranchCode,'')
	...
	values
		(1,@ProcessNo,@FiscalYear,@SerialNo,@RowNo,@RowNo,@DocDate,@DocDate,@PayTypeID,@BankCode,@CustomerCode,
