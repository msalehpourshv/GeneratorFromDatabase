...
-- Description   : 
-- =============================================
CREATE PROCEDURE inv.sp_api_AppService_GetBuysDtl
...
BEGIN TRY
	...
	SET @strQuery=' 
			SELECT DocDate , FiscalYear , ProcessNo , SerialNo , D.StoreID , DescDtl , G.GoodsID , GoodsName , 
				   cast( D.GoodsPrice as float) as  GoodsPrice,cast( GoodsQuantity as float)as GoodsQuantity, D.RowNo , 
				   D.SaleTypeID , u.UnitName , TechnicalNo , S.StoreName , DiscountPercentDtl ,DiscountDtl 
			...
			WHERE ProcessID=55 AND SerialNo=' + @SerialNo + ' AND
