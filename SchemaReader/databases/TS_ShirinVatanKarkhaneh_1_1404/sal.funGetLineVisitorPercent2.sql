...
Create FUNCTION [sal].[funGetLineVisitorPercent2]
(
...
Begin -- === S T A R T ===========================================
	...
	SELECT  TOP 1  @Result = VisitorPercent2
	...
	WHERE (VisitorPercent2 > 0) AND D.ProcessID = 200 AND ((FromDate<=@DocDate AND ToDate>=@DocDate)) 
