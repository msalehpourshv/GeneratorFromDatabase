...
-- Last Modifier : 
-- ----------------------------------------------
-- Description	 : < پیش فاکتورها برای CRM  رز>
-- ==============================================
Create PROCEDURE crm.SpPreSaleForRozCRM
	@AcntCode			Varchar(20), 
	@FrSerialNo			int,
	@ToSerialNo			int,
	@FrDate				char(10),
...
BEGIN
	...
	set @StrSelect='	
			SELECT b.ProcessID,b.ProcessNo,b.FiscalYear,b.SerialNo,RowNo,b.DocDate,b.GoodsID,GoodsName,GoodsQuantity,GoodsAmount
					...
					,pub.GetCodeName(b.VisitorAcntCode2, 1) VisitorName2,b.VisitorPercent2,a.DocDesc
					FROM	inv.tblPreSaleDtl  b
