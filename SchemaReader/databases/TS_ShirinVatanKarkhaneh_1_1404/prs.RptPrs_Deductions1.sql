...
-- Description	 : لیست کسورات مستمر
-- ==============================================
CREATE PROCEDURE [prs].[RptPrs_Deductions1] 
...
Begin 
	...
	IF (@DeductionID Is Not Null)
		SET @StrFieldsSum1 = 'Deduction' + LTrim(@DeductionID)
	Else
		EXEC [pub].[SpConcatSimilarCols] 'prs', 'DecreeHdr', 'Deduction0', '+', @StrFieldsSum1 OUTPUT
