...
--Description   : 
--================================================
Create PROCEDURE [acc].[SpVch_CreatDocTranfered_Dis]
  @ProcessID AS INT,
  @ProcessNo AS INT,
...
BEGIN
  ...
  BEGIN TRY
	...
	DECLARE  aa_curs CURSOR FOR   
	   SELECT  VchNo,DocDate,ProcessID, 0 ProcessNo,BaseFiscalYear FiscalYear,SerialNo ,Tax_Type 
	   FROM     sal.tblAfterSaleBillHdr
	  ...
	  BEGIN
		  ...
		  BEGIN
			...
			EXEC [acc].[SpVch_CreateDoc]   
					...
					@strHdrTblName		= 'sal.tblAfterSaleBillHdr',  
