...
-- Description	 : 
-- ==============================================
CREATE PROCEDURE [pln].[RptProductSaleOrders2]
...
Begin
	...
	-- ================================
	SET @StrSelect = '
    SELECT	D.ProcessID, D.ProcessNo, D.FiscalYear, D.SerialNo, D.RowNo, D.DocStep, D.DocRowNo, D.DocDate, D.AcntCode, D.GoodsID,
    ...
    WHERE	D.ProcessID =180 and  ' + @StrWhere + '
	GROUP BY D.ProcessID, D.ProcessNo, D.FiscalYear, D.SerialNo, D.RowNo, D.DocStep, D.DocRowNo, D.DocDate, D.AcntCode, D.GoodsID, D.ConstText1,D.ConstText2,D.ConstText3,D.ConstText4,D.SgnSN1,D.SgnSN2,D.SgnSN3,D.SgnSN4,D.SgnSN5 '
	...
	SET @StrSelect = '
	SELECT  ProcessID, ProcessNo, FiscalYear, SerialNo, RowNo, DocRowNo, DocDate, AcntCode, AcntName, TotalQuantity, CanceledQuantity,SgnSN1,SgnSN2,SgnSN3,SgnSN4,SgnSN5,
			(
	...
	WHERE ' + @StrWhere_G + '
	GROUP BY ProcessID, ProcessNo, FiscalYear, SerialNo, RowNo, DocRowNo, DocDate, AcntCode, AcntName, T.GoodsID, TotalQuantity, CanceledQuantity,ConstText1,ConstText2,ConstText3,ConstText4,SgnSN1,SgnSN2,SgnSN3,SgnSN4,SgnSN5 '
