...
-- Last Modified : 
-- Last Modifier : 
-- Description   : <حذف اتوماتیک ارسال و دریافت تولید بر اساس BOM کالا>
-- =================================================================
CREATE PROCEDURE [prd].[SPDeleteAutoProduct]
	@SNo		INT = 97
...
BEGIN
   ...
   BEGIN TRY
	...
	from inv.tblStorageDocsHdr where AgreeNo=@SNo and ProcessID=80
