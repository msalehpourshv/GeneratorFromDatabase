...
-- ==============================================
-- crm.SpPreSaleHdrForTSCRM 
Create PROCEDURE crm.SpPreSaleHdrForTSCRM
...
BEGIN
	...
	set @StrSelect='	
			SELECT a.ProcessID,a.ProcessNo,a.FiscalYear,a.SerialNo,a.DocDate
					...
					,a.SaleTypeID,SaleTypeName,a.VisitorAcntCode, pub.GetCodeName(a.VisitorAcntCode, 1) VisitorName,a.VisitorPercent
