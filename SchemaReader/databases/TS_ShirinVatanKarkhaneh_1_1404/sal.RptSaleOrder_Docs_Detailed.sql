...
-- Last Modified : 1392/06/28
-- Last Modifier : TakroSystem\Zia
-- Description   : لیست سفارشات - تفصیلی
-- =============================================
Create PROCEDURE [sal].[RptSaleOrder_Docs_Detailed]
	@ProcessNo		Int = 1,
...
Begin --============== S T A R T  C O D E ===================================================
	...
	SELECT a.* , b.UnitID  UnitIDBase , U.UnitName UnitNameBase
	 ,isnull(UnitValue,1)UnitValue,isnull(MainUnitValue,1)MainUnitValue, isnull(SubUnitID,'')SubUnitID,isnull(U2.UnitName ,'') UnitNameSubUnitID
	 , ( SELECT  top 1 ManualUserPrice  FROM sal.tblGoodsPriceForCustomerKindDtl D inner join sal.tblGoodsPriceForCustomerKindHdr H on D.SerialNo=H.SerialNo where GoodsID=a.GoodsID and FromDate<=a.DocDate order by DocDate Desc , D.SerialNo Desc )ManualUserPrice 
