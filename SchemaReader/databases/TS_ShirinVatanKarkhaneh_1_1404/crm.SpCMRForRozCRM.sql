...
-- Last Modifier : 
-- ----------------------------------------------
-- Description	 : <  درخواست خرید کالا برای CRM  رز>
-- ==============================================
Create PROCEDURE crm.SpCMRForRozCRM
	@AcntCode			Varchar(20), 
	@FrSerialNo			int,
	@ToSerialNo			int,
	@FrDate				char(10),
...
BEGIN
	...
	set @StrSelect='SELECT 			
						b.ProcessID	,b.ProcessNo	,b.FiscalYear	,b.SerialNo	,b.RowNo	,b.DocRowNo	,b.DocStep	,b.DocDate	,b.AcntCode	,b.GoodsID
						,b.SubUnitID	,b.SubUnitQuantity	,b.ConfirmQuantity	,b.GoodsQuantity	,b.DescDtl	,b.OrderDate	,b.BaseProcessID	
						,b.BaseProcessNo	,b.BaseFiscalYear	,b.BaseSerialNo	,b.BaseDocRowNo	,b.BaseDocDate	,b.Priority	,b.DescDtl2
						,GoodsName,GoodsQuantity,a.AcntCode, pub.GetCodeName(a.AcntCode, 1) AcntName,b.AcntCode AcntCodeDtl,pub.GetCodeName(b.AcntCode, 1) AcntNameDtl
						,DescDtl,b.DocStep ,  SubUnitQuantity,SubUnitID,IsNull(U.UnitName,'''') As SubUnitName,a.DocDesc					
					FROM	cmr.tblCMRDtl  b
