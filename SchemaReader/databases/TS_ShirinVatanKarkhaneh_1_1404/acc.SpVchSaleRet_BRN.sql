...
-- Description   : 
-- ================================================
CREATE PROCEDURE [acc].[SpVchSaleRet_BRN]
	@intVchNo				Int,
	@intDocStep				TinyInt,
    @strVchDate				Char(10),
...
Declare @SaleReturnAcntCode as varchar(20),
...
Exec sp_executesql  @strQuery, @StrParams, @PropertyName OUTPUT;
	...
	Declare	curInvVch CURSOR For 
		...
		BEGIN
			IF @Price <> 0
				BEGIN
					SELECT	@SaleReturnAcntCode=[acc].[funMerg_AcntCode](SaleReturnAcntCode,@AcntCode2,@AcntCode3,@AcntCode4),
					...
					--------------------------
						...
						VALUES	(@intVchNo,@intSourceProcessID,@intSourceProcessNo,@intSourceFiscalYear,@intSourceSerialNo,@strVchDate ,1,@SessionNo ,1,@intMaxRowNo ,@intMaxDocRowNo,
									@SaleReturnAcntCode,ROUND(@Price- @Tax -@Toll,0),0,TS.pub.funChangeFarsiStrings(pub.funReverseForCrystal(@strRecDesc)),'',8,@StrSourceCodeFieldValue)
						...
						BEGIN
							...
							INSERT INTO acc.tblVoucherDtl
									(SerialNo,SourceProcessID,SourceProcessNo,SourceFiscalYear,SourceSerialNo,DocDate,IsAutoDoc,SessionNo,VchKind,RowNo,DocRowNo,
										AcntCode,Debit,Credit,RecDesc,RecDesc2,SourceDocType,SourceCodeFieldValue) 
							VALUES	(@intVchNo,@intSourceProcessID,@intSourceProcessNo,@intSourceFiscalYear,@intSourceSerialNo,@strVchDate ,1,@SessionNo ,1,@intMaxRowNo ,@intMaxDocRowNo,
										@SaleDiscountAcntCode,0,ROUND(@Discount,0),TS.pub.funChangeFarsiStrings(pub.funReverseForCrystal(@strRecDesc2)),'',8,@StrSourceCodeFieldValue)
						END
