...
create FUNCTION [prd].[funGetProducersWageSimilarMax] 
...
BEGIN
	...
	select top 1 c.GoodsQuantity*[prd].[funGetProducersWageRemain] 
	...
	inner join prd.tblFormulasAtm c
	on a.ProductID=c.ProductID and a.SerialNo=c.SerialNo and a.DocRowNo=c.DocRowNo
	where b.ProductID=@ProductID and b.SerialNo=@FormulaSNo 
	and c.GoodsID=@GoodsID),0)-
