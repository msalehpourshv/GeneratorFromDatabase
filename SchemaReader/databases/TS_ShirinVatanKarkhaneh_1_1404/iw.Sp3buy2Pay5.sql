...
-- Last Modifier : 
-- ----------------------------------------------
-- Description	 : <5 لیست تخفیفات 2 تا بخر 3 تا ببر>
-- ==============================================
Create PROCEDURE iw.Sp3buy2Pay5
	@UserID		int,
...
BEGIN	
	...
	set @StrSelect='select  Count(*)over () TotalCount, H.SerialNo	,H.FiscalYear	,H.DocDate	,H.FromDate	,H.ToDate	
						...
						,H.XBuy	,H.YPay,D1.DocRowNo	,D1.ExFld5
					from   sal.tbl3buy2PayHdr H
					left Join sal.tbl3buy2PayDtl5 D1 On D1.SerialNo=H.SerialNo and 	D1.FiscalYear=H.FiscalYear
					where 1= 1'
