...
-- Description	 : گزارش لیست برگه های خدمات
-- ==============================================
Create PROCEDURE [acc].[RptAcc_ServicesList_Detailed]
	@ProcessNo			Int = 1,
	@SerialNoFr			Int = Null,
	@SerialNoTo			Int = Null,
	@VchNoFr			Int = Null,
...
BEGIN -- ============================ S T A R T =====================================================
	...
	SELECT	H.*, D.DocRowNo, D.ServiceID, D.DescDtl, D.ServiceQuantity, D.ServiceAmount, 
			...
			F.Address1, F.Address2, F.CompanyRegisterNo, F.NationalIDNumber, F.OrganzationName, 
			F.ZipCode, IsNull(F.Tel, '''') Tel, LH.AreaCode, pub.funGetLocationName(F.LocationID, 1) as LocationName
			,D.TaxOverWorthCostDtl,D.TollOverWorthCostDtl ,DiscountPercentDtl	,DiscountDtl,NationalIdentity
