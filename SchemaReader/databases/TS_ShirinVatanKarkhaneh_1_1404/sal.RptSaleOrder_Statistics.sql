...
-- ==============================================
CREATE PROCEDURE [sal].[RptSaleOrder_Statistics]
	@ProcessNo		Int = 1,
...
Begin --============== S T A R T  C O D E ===================================================
	...
	Set @StrSelect = '
	SELECT	' + @CodeField + ', ' + @NameField + ', ' + @BalanceField + ' BalanceQuantity,
			Sum(GoodsQuantity) GoodsQuantity, Sum(CancelQuantity) CancelQuantity, 
	...
	(
		...
		FROM    sal.tblSaleOrderDtl AS D
					INNER JOIN sal.tblSaleOrderHdr H ON H.ProcessID = D.ProcessID AND H.ProcessNo = D.ProcessNo AND 
