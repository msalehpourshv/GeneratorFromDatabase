...
-- Create date   : 1395/03/19
-- Viewed By	 : 
-- Last Modified : 1395/03/19
-- Last Modifier : TakroSystem\Hamid
-- Description   : 
-- =============================================
--EXEC [prd].[SPGetProductSendRemain] 1, 790
CREATE PROCEDURE [prd].[SPGetProductSendRemain]
	@ProcessNo	Int = Null,
	@SerialNo	Int = Null
...
Begin --============== S T A R T  C O D E ===================================================
	...
	Where D.ProcessID = 70 And D.ProcessNo = @ProcessNo And D.SerialNo = @SerialNo
