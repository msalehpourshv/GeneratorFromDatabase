...
--Create date   : 92/03/05
--Viewed By	 : 
--Last Modified : 
--Description   : 
--================================================
CREATE   PROCEDURE [acc].[SpVch_CreatDocTranfered_Pty]
  @ProcessID AS INT,
  @ProcessNo AS INT,
...
BEGIN
  ...
  BEGIN TRY
	...
	DECLARE  aa_curs CURSOR FOR   
	   SELECT  VchNo,VchDate,ProcessID,ProcessNo,FiscalYear,SerialNo ,Tax_Type 
	  ...
	  BEGIN
		  ...
		  BEGIN
			...
			EXEC [acc].[SpVch_CreateDoc]   
					...
					@strHdrTblName		= 'trs.tblPettyCashHdr',  
