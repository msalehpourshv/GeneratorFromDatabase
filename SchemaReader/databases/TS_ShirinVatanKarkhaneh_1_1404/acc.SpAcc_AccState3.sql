...
-- ==============================================
Create procedure acc.SpAcc_AccState3
...
select  @SPID2=  SourceProcessID,@SPNo2=SourceProcessNo,@SF2=SourceFiscalYear,@SS2=SourceSerialNo,@SSD2=SourceDocRowNo,@SID2=BaseID,@VisitorAcntCode2=VisitorAcntCode,@Amount2=Amount,@ID2=ID from #T2
