...
-- Description   : 
-- =============================================
CREATE PROCEDURE sal.sp_api_AppService_GetSalesOrderDtl
...
BEGIN TRY
	...
	SET @strQuery ='
				SELECT DocDate , FiscalYear , ProcessNo ,ProcessID, SerialNo , D.StoreID , DescDtl , G.GoodsID , 
					   ...
					   D.SaleTypeID , u.UnitName , TechnicalNo , S.StoreName ,
					   TaxOverWorthCostDtl as TaxOverWorthCost,TollOverWorthCostDtl as TollOverWorthCost,
					   cast( DiscountPercentDtl as float) as DiscountPercentDtl,cast(DiscountDtl as float) as DiscountDtl ,
					   CASE
