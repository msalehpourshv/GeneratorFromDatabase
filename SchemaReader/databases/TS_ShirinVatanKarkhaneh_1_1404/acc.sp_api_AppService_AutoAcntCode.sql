...
GO
create PROCEDURE [acc].[sp_api_AppService_AutoAcntCode]
...
@PersonType as int,
@AcntCustomerCode as NVARCHAR(50)
...
BEGIN TRY
	...
	BEGIN
		...
		(AcntCode,PartNumber,Tel,Mobile,Fax,EconomicalCode,NationalIDNumber,Email,PersonType,
		 AccountNumber,ShabaAccountNumber,BirthDate,NationalIdentity)
		VALUES
		(@AcntCode,@CustomerPartNo,@Tel,@Mobile,@Fax,@EconomicalCode,@NationalIDNumber,@Email,@PersonType,
		 @AccountNumber,@ShabaAccountNumber,@BirthDate,@NationalIdentity)
