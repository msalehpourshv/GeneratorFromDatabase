...
-- ====================================================
CREATE PROCEDURE [cmr].[RptBuyOrder_Statistics_Detailed]
	@ProcessNo		Int = 1,
	@SelectedGoods	Int = 0, 
	@SelectedAcnt1	Int = 0, 
	@SelectedAcnt2	Int = 0, 
...
Begin --============== S T A R T  C O D E ====================================
	...
	SET @StrSelect = '
	SELECT	GoodsID, AcntCode, Sum(GoodsQuantity) OrderedQty, 
			Sum(CanceledQty) AS CanceledQty, Sum(BoughtQty) AS BoughtQty,
