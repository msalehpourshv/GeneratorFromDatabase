...
-- =============================================================================================
-- =============================================================================================
CREATE PROCEDURE prd.RptPrd_FormulasTree_SHV
	@SelectedProds	Int = 0,
	@SelectedSemis	Int = 0,
	@SelectedGoods	Int = 0,
	@SelectedStore	Int = 0,
...
BEGIN
	...
	select D.GoodsID, isnull([inv].[funGetGoodsRemain](NULL, NULL, NULL, NULL, NULL, NULL, D.GoodsID,  NULL, ''1500/12/29'', 0), 0) Balance
