...
-- =============================================================================================
-- =============================================================================================
CREATE PROCEDURE pln.SPTaskOrderStandard_5_SHV
@CallType Int, 
...
--	select  * into tblTempStansard3 from #tblTempStansard3
  ...
  set @Colname2=''
	...
	--set @StrSelect=' 
	--FiscalYear, SerialNo Task_No, BaseSerialNo Order_No, DocDate, ProductID, GoodsName Product_Name, ShiftTypeName Shift_Name, 
	--ProductionLineName Line_Name, PureWeight, GoodsWeight, OrderCount Order_Count, ExitCountStandard Standard_Prd_Weight, ExitCount Prd_Weight, 
	--ProductCountStandard Standard_Prd_Count, ProductCount Prd_Count, OperatorCountStandard Standard_Operator_Count, OperatorCount Operator_Count,
	--OperatorCountStandard - OperatorCount Operator_Except, Startdate, FinishDate, FinishDate2, TimeCountMin, StopTime'

	set @StrSelect=' 
	FiscalYear, SerialNo Task_No, BaseSerialNo Order_No, DocDate, ProductID, GoodsName Product_Name, ShiftTypeName Shift_Name, 
	ProductionLineName Line_Name, PureWeight, GoodsWeight, OrderCount Order_Count, ProductCount Prd_Count, 
	OperatorCount Operator_Count, Startdate, FinishDate, TimeCountMin, StopTime'
	...
	begin
		...
		set @StrSelect='Select Distinct  a.*, G.UnitID, UnitName 
		                From (
						      SELECT ' + @StrSelect + '--, ' + @Colname2 + '
							  FROM 
							  (
