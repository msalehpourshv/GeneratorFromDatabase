...
-- Description   : 
-- =============================================
create PROCEDURE inv.sp_api_AppService_CreateBuyHdr
@ProcessNo as Int,
@FiscalYear as Int,
@DocStep as tinyint,
@DocDate as CHAR(10),
...
BEGIN TRY
	...
	BEGIN
		...
		Amount,Price, DiscountPercent, Discount,DocDesc,SaleTypeID,
		DiscountAcntCode,TaxOverWorthCost, TollOverWorthCost,DocDate2,DocDate3, DocDate4, IsAutoDoc,
		TransportationIncomeAcntCode,TransferSerialNo)
	
		SELECT 55, @ProcessNo, @FiscalYear, @maxSerialNo, @DocStep, @DocDate, @StoreID, @AcntCode, 
		@Amount,@Price,@DiscountPercent,@Discount,@DocDesc,
