...
-- Description	 : < ������ �ǘ��� �ѐ�� �� ����  >
-- ==============================================
Create PROCEDURE iw.SpSaleRetInvoiceInfo
	@UserID			int,
...
DECLARE @StrSelect		NVarChar(MAX);
	...
	where H.ProcessID=100 and H.ProcessNo='+ str(@ProcessNo)+ ' and H.FiscalYear='+ str(@FiscalYear)+ ' and H.SerialNo='+ str(@SerialNo)+ ' '
