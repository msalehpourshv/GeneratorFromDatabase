...
-- Description	 : 
-- ==============================================
Create PROCEDURE [trs].[SpPayableTrust] 
...
where D.ProcessID=33 AND ( (D.ChequeDate <>'' and D.ChequeDate<=@DocDate) or  (D.EndDate_PayableTrust <>'' and D.EndDate_PayableTrust<=@DocDate) or (D.ChequeDate='' and D.EndDate_PayableTrust=''))
